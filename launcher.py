...
# listen for A+C pressed at startup, to quit launcher
...
# set the intial state, what page we are on and what app is running
...
# Create an array of apps, scan the apps directory for .py files
apps = [x[:-3] for x in os.listdir("/apps") if x.endswith(".py")]

# calculate the number of pages needed (3 apps per page) for the page idicator
...
# routine to draw the disk usage icon
...
# =============================================================================
# key routine to render the launcher screen
...
# =============================================================================
# after receiving a button press, pause for a moment to allow the user to release
...
# =============================================================================
# routine to launch the specific app requested
